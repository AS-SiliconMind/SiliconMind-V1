...
| **Dual Workflow** | *Deep Thinking* — single-pass solve + self-debug · *Agentic* — iterative solve → duck → debug loop |
...
> Runnable examples: [sample/agentic.py](sample/agentic.py) · [sample/deepthinking.py](sample/deepthinking.py) · [sample/agentic_batch.py](sample/agentic_batch.py) · [sample/deepthinking_batch.py](sample/deepthinking_batch.py)
